...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/04/03 18:57:09 by marvin            #+#    #+#             */
/*   Updated: 2023/04/03 18:57:09 by marvin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char    *read_and_stach(int fd, char *stash) /* User read to add to the stash */
{    
    char *buff;
    ssize_t readed;
...
static char *ft_clean_stash(char *stash) /* After extract the line was read*/
{
    char *new_stash;
    int i;
    int j;
